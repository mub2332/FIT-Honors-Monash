...
public class DataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private void loadProjects() {
        ...
        project00059.setTitle("Online Handwritten Signature Verification");
        project00059.setDescription("This project is in an area of my earlier research. A number of research papers were published.");
        project00059.setCreditPoints(new ArrayList<Integer>(Arrays.asList(24)));
        project00059.setAimsAndOutline("There is considerable interest in authentication based on handwritten signature verification (HSV) because HSV is superior to many other biometric authentication techniques , for example, fingerprints or retinal pattern which are more reliable but much more intrusive.\n A number of HSV techniques have been explored over the last 30-40 years. I myself have looked into using dynamic parameters when a signature is signed online. Another approach was based on simulating the hand movements of the person signing online. Both these techniques work well and the results have been published. This project involves finding even more reliable techniques perhaps by exploring yet another approach to online HSV based on identifying curves and straight lines as the signature is signed. You will need to study curves and lines identification techniques in pattern recognition and then use those techniques and perhaps develop new techniques for use in online HSV. The project requires some mathematical knowledge and programming experience.");
        ...
        project00059.setUrlsAndReferences(new ArrayList<String>(Arrays.asList("(with R. C. Joyce) Using Position Extrema Points to Capture Shape in On-line Handwritten\nSignature Verification, Pattern Recognition, Vol. 40 pp 2811-2817, 2007", "The State of the Art in On-line Handwritten Signature Verification, approx 38pp,\nFaculty of Information Technology, Technical Report, 2006")));
        ...
        project00060.setTitle("Online Handwritten Signature Verification");
        project00060.setDescription("This project is in an area of my earlier research. A number of research papers were published.");
        project00060.setCreditPoints(new ArrayList<Integer>(Arrays.asList(24)));
        project00060.setAimsAndOutline("There is considerable interest in authentication based on handwritten signature verification (HSV) because HSV is superior to many other biometric authentication techniques , for example, fingerprints or retinal pattern which are more reliable but much more intrusive.\n A number of HSV techniques have been explored over the last 30-40 years. I myself have looked into using dynamic parameters when a signature is signed online. Another approach was based on simulating the hand movements of the person signing online. Both these techniques work well and the results have been published. This project involves finding even more reliable techniques perhaps by exploring yet another approach to online HSV based on identifying curves and straight lines as the signature is signed. You will need to study curves and lines identification techniques in pattern recognition and then use those techniques and perhaps develop new techniques for use in online HSV. The project requires some mathematical knowledge and programming experience.");
        project00060.setPreAndCorequisiteKnowledge("The student must have some mathematical background and experience in programming");
        project00060.setSupervisors(new ArrayList<String>(Arrays.asList("Gopal Gupta")));
        project00060.setUrlsAndReferences(new ArrayList<String>(Arrays.asList("(with R. C. Joyce) Using Position Extrema Points to Capture Shape in On-line Handwritten\nSignature Verification, Pattern Recognition, Vol. 40 pp 2811-2817, 2007", "The State of the Art in On-line Handwritten Signature Verification, approx 38pp,\nFaculty of Information Technology, Technical Report, 2006")));
        ...
        project00061.setTitle("Online Handwritten Signature Verification");
        project00061.setDescription("This project is in an area of my earlier research. A number of research papers were published.");
        project00061.setCreditPoints(new ArrayList<Integer>(Arrays.asList(24)));
        project00061.setAimsAndOutline("There is considerable interest in authentication based on handwritten signature verification (HSV) because HSV is superior to many other biometric authentication techniques , for example, fingerprints or retinal pattern which are more reliable but much more intrusive.\n A number of HSV techniques have been explored over the last 30-40 years. I myself have looked into using dynamic parameters when a signature is signed online. Another approach was based on simulating the hand movements of the person signing online. Both these techniques work well and the results have been published. This project involves finding even more reliable techniques perhaps by exploring yet another approach to online HSV based on identifying curves and straight lines as the signature is signed. You will need to study curves and lines identification techniques in pattern recognition and then use those techniques and perhaps develop new techniques for use in online HSV. The project requires some mathematical knowledge and programming experience.");
        project00061.setPreAndCorequisiteKnowledge("The student must have some mathematical background and experience in programming");
        project00061.setSupervisors(new ArrayList<String>(Arrays.asList("Gopal Gupta")));
        project00061.setUrlsAndReferences(new ArrayList<String>(Arrays.asList("(with R. C. Joyce) Using Position Extrema Points to Capture Shape in On-line Handwritten\nSignature Verification, Pattern Recognition, Vol. 40 pp 2811-2817, 2007", "The State of the Art in On-line Handwritten Signature Verification, approx 38pp,\nFaculty of Information Technology, Technical Report, 2006")));
        ...
        project00062.setTitle("Online Handwritten Signature Verification");
        project00062.setDescription("This project is in an area of my earlier research. A number of research papers were published.");
        project00062.setCreditPoints(new ArrayList<Integer>(Arrays.asList(24)));
        project00062.setAimsAndOutline("There is considerable interest in authentication based on handwritten signature verification (HSV) because HSV is superior to many other biometric authentication techniques , for example, fingerprints or retinal pattern which are more reliable but much more intrusive.\n A number of HSV techniques have been explored over the last 30-40 years. I myself have looked into using dynamic parameters when a signature is signed online. Another approach was based on simulating the hand movements of the person signing online. Both these techniques work well and the results have been published. This project involves finding even more reliable techniques perhaps by exploring yet another approach to online HSV based on identifying curves and straight lines as the signature is signed. You will need to study curves and lines identification techniques in pattern recognition and then use those techniques and perhaps develop new techniques for use in online HSV. The project requires some mathematical knowledge and programming experience.");
        project00062.setPreAndCorequisiteKnowledge("The student must have some mathematical background and experience in programming");
        project00062.setSupervisors(new ArrayList<String>(Arrays.asList("Gopal Gupta")));
        project00062.setUrlsAndReferences(new ArrayList<String>(Arrays.asList("(with R. C. Joyce) Using Position Extrema Points to Capture Shape in On-line Handwritten\nSignature Verification, Pattern Recognition, Vol. 40 pp 2811-2817, 2007", "The State of the Art in On-line Handwritten Signature Verification, approx 38pp,\nFaculty of Information Technology, Technical Report, 2006")));
